...
-- *****************************************************************************
-- Generated on "10/16/2018 15:40:50"
...
BEGIN
	CIn(31) <= '0';
WAIT;
END PROCESS t_prcs_CIn_31;
-- CIn[30]
t_prcs_CIn_30: PROCESS
BEGIN
	CIn(30) <= '0';
WAIT;
END PROCESS t_prcs_CIn_30;
-- CIn[29]
t_prcs_CIn_29: PROCESS
BEGIN
	CIn(29) <= '0';
WAIT;
END PROCESS t_prcs_CIn_29;
-- CIn[28]
t_prcs_CIn_28: PROCESS
BEGIN
	CIn(28) <= '0';
WAIT;
END PROCESS t_prcs_CIn_28;
-- CIn[27]
t_prcs_CIn_27: PROCESS
BEGIN
	CIn(27) <= '0';
WAIT;
END PROCESS t_prcs_CIn_27;
-- CIn[26]
t_prcs_CIn_26: PROCESS
BEGIN
	CIn(26) <= '0';
WAIT;
END PROCESS t_prcs_CIn_26;
-- CIn[25]
t_prcs_CIn_25: PROCESS
BEGIN
	CIn(25) <= '0';
WAIT;
END PROCESS t_prcs_CIn_25;
-- CIn[24]
t_prcs_CIn_24: PROCESS
BEGIN
	CIn(24) <= '0';
WAIT;
END PROCESS t_prcs_CIn_24;
-- CIn[23]
t_prcs_CIn_23: PROCESS
BEGIN
	CIn(23) <= '0';
WAIT;
END PROCESS t_prcs_CIn_23;
-- CIn[22]
t_prcs_CIn_22: PROCESS
BEGIN
	CIn(22) <= '0';
WAIT;
END PROCESS t_prcs_CIn_22;
-- CIn[21]
t_prcs_CIn_21: PROCESS
BEGIN
	CIn(21) <= '0';
WAIT;
END PROCESS t_prcs_CIn_21;
-- CIn[20]
t_prcs_CIn_20: PROCESS
BEGIN
	CIn(20) <= '0';
WAIT;
END PROCESS t_prcs_CIn_20;
-- CIn[19]
t_prcs_CIn_19: PROCESS
BEGIN
	CIn(19) <= '0';
WAIT;
END PROCESS t_prcs_CIn_19;
-- CIn[18]
t_prcs_CIn_18: PROCESS
BEGIN
	CIn(18) <= '0';
WAIT;
END PROCESS t_prcs_CIn_18;
-- CIn[17]
t_prcs_CIn_17: PROCESS
BEGIN
	CIn(17) <= '0';
WAIT;
END PROCESS t_prcs_CIn_17;
-- CIn[16]
t_prcs_CIn_16: PROCESS
BEGIN
	CIn(16) <= '0';
WAIT;
END PROCESS t_prcs_CIn_16;
-- CIn[15]
t_prcs_CIn_15: PROCESS
BEGIN
	CIn(15) <= '0';
WAIT;
END PROCESS t_prcs_CIn_15;
-- CIn[14]
t_prcs_CIn_14: PROCESS
BEGIN
	CIn(14) <= '0';
WAIT;
END PROCESS t_prcs_CIn_14;
-- CIn[13]
t_prcs_CIn_13: PROCESS
BEGIN
	CIn(13) <= '0';
WAIT;
END PROCESS t_prcs_CIn_13;
-- CIn[12]
t_prcs_CIn_12: PROCESS
BEGIN
	CIn(12) <= '0';
WAIT;
END PROCESS t_prcs_CIn_12;
-- CIn[11]
t_prcs_CIn_11: PROCESS
BEGIN
	CIn(11) <= '0';
WAIT;
END PROCESS t_prcs_CIn_11;
-- CIn[10]
t_prcs_CIn_10: PROCESS
BEGIN
	CIn(10) <= '0';
WAIT;
END PROCESS t_prcs_CIn_10;
-- CIn[9]
t_prcs_CIn_9: PROCESS
BEGIN
	CIn(9) <= '0';
WAIT;
END PROCESS t_prcs_CIn_9;
-- CIn[8]
t_prcs_CIn_8: PROCESS
BEGIN
	CIn(8) <= '0';
WAIT;
END PROCESS t_prcs_CIn_8;
-- CIn[7]
t_prcs_CIn_7: PROCESS
BEGIN
	CIn(7) <= '0';
WAIT;
END PROCESS t_prcs_CIn_7;
-- CIn[6]
t_prcs_CIn_6: PROCESS
BEGIN
	CIn(6) <= '0';
WAIT;
END PROCESS t_prcs_CIn_6;
-- CIn[5]
t_prcs_CIn_5: PROCESS
BEGIN
	CIn(5) <= '0';
WAIT;
END PROCESS t_prcs_CIn_5;
-- CIn[4]
t_prcs_CIn_4: PROCESS
BEGIN
	CIn(4) <= '0';
WAIT;
END PROCESS t_prcs_CIn_4;
-- CIn[3]
